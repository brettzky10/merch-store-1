...
import { saveOrder, resetCart } from '@/lib/redux/shoppingSlice';
import { useState } from 'react';
//import { BsBagFill } from 'react-icons/bs';
//import { RxCross2 } from 'react-icons/rx';
import { useDispatch, useSelector } from 'react-redux';
import { Product, StateProps } from '@/lib/types/Product';
  ...
  return (
    <div className="relative inline-block">
      <button onClick={openCart} className="relative flex justify-center items-center">
        ...
        <ShoppingBag className="text-current text-2xl z-2" />
      </button>
      {/* Cart Open */}
      <div >
        {isOpen ? (
          <div className="fixed top-0 right-0 h-screen w-1/3 bg-primary-foreground border-l-1 border-foreground/50 z-[100]">
