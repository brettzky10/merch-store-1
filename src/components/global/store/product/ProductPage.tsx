...
import { SyncVariant, SyncProduct } from '@/lib/types/Product';
        ...
        <div className='w-1/2 text-left pl-24 '>
          ...
          <div className="mt-4 flex flex-col ">
            ...
            <Input
              ...
              className="w-16 text-lg border border-primary rounded-sm focus:outline-none enabled:hover:border-primary-400 enabled:hover:border text-center"
            />
          </div>
